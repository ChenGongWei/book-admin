	...
	<view class="uni-container">
		<uni-forms ref="form" v-model="formData" :rules="rules" validateTrigger="bind" @submit="submit">
			...
			<uni-forms-item name="nickname" label="姓名" required>
				<uni-easyinput v-model="formData.nickname" :clearable="false" placeholder="请输入姓名" />			</uni-forms-item>
			<uni-forms-item name="role" label="角色列表" class="flex-center-x" required>
		...
		methods: {
			...
			getDetail(id) {
				...
				db.collection(dbCollectionName)
					.doc(id)
					.field('username,nickname,role,mobile,email,status')
					.get()
					.then((res) => {
